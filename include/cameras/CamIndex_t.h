#ifndef APTRACER_CAMINDEX_T_H
#define APTRACER_CAMINDEX_T_H
...
namespace APTracer { namespace Cameras {
     ...
     */
    class CamIndex_t final : public Camera_t{
        public:
            /**
             * @brief Construct a new CamIndex_t object. Most arguments are passed to the Camera_t constructor.
             * 
             ...
             */
            CamIndex_t(TransformMatrix_t* transformation, const std::string &filename, Vec3f up, std::array<double, 2> fov, std::array<unsigned int, 2> subpix, ImgBuffer_t* image, std::list<Medium_t*> medium_list, Skybox_t* skybox, unsigned int max_bounces, double gammaind);
            
            /**
             * @brief Destroy the CamIndex_t object. Does nothing.
             */
            virtual ~CamIndex_t() final;
